...
/* rofi */
static const char *roficmd[]  = { "/bin/sh", "-c", "$(rofi -modi drun -show drun -font 'hack 18' -show combi -show-icons -icon-theme 'Papirus' -fullscreen)", NULL };
static const char *rofialt[]  = { "/bin/sh", "-c", "$(rofi -show window -font 'hack 24' -fullscreen)", NULL };
static const char *power[]  = { "/bin/sh", "-c", "$(~/.config/rofi/scripts/sysmenu)", NULL };
